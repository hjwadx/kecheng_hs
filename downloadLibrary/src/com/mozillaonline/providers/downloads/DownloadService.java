...
public class DownloadService extends Service {
	...
	private void trimDatabase() {
		Cursor cursor = getContentResolver()
				.query(Downloads.ALL_DOWNLOADS_CONTENT_URI, new String[] { Downloads._ID }, Downloads.COLUMN_STATUS + " >= '200'", null, Downloads.COLUMN_LAST_MODIFICATION);
		if (cursor == null) {
	...
	private void updateDownload(DownloadInfo.Reader reader, DownloadInfo info, long now) {
		...
		boolean lostVisibility = oldVisibility == Downloads.VISIBILITY_VISIBLE_NOTIFY_COMPLETED && info.mVisibility != Downloads.VISIBILITY_VISIBLE_NOTIFY_COMPLETED
