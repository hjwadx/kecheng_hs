...
//        Log.d(Const.TAG, "onMesure widthMode=" + widthMode + ", heightMode="+heightMode);
...
//            Log.d(Const.TAG, "child.getMeasuredHeight()=" + child.getMeasuredHeight() + ", height="+height + "child.getMeasuredWidth()=" + child.getMeasuredWidth() + ", width="+width);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			if (mIsBeingDragged) {
				...
				// top_scrollView.scrollBy((int)deltaX, (int)deltaY);
				// left_scrollView.scrollBy((int)deltaX, (int)deltaY);
			...
			if (mIsBeingDragged) {
				if (mFlingEnabled) {
					...
					velocityTracker.computeCurrentVelocity(1000,
							mMaximumVelocity);
					int initialVelocitx = Compatibility.getXVelocity(velocityTracker, mActivePointerId);
					int initialVelocity = Compatibility.getYVelocity(velocityTracker, mActivePointerId);
...
//                mScrollViewMovedFocus = false;  
//            }  
//            top_scrollView.fling(velocityX);
//            left_scrollView.fling(velocityY);
...
//			
//			evForWeekView.setLocation(getAjustedX(ev.getX()), getAjustedY(ev.getY()));
