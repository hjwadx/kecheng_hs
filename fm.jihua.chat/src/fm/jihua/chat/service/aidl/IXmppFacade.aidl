...
*/
package fm.jihua.chat.service.aidl;

import fm.jihua.chat.service.aidl.IXmppConnection;
import fm.jihua.chat.service.aidl.IRoster;
import fm.jihua.chat.service.aidl.IChatManager;
import fm.jihua.chat.service.aidl.IPrivacyListManager;
import fm.jihua.chat.service.PresenceAdapter;
import fm.jihua.chat.service.UserInfo;
...
interface IXmppFacade {
    ...
    UserInfo getUserInfo();
     ...
     List<Message> requestHistoryMessage(String from, String to, int offset, int count);
