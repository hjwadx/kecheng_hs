...
public class CustomViewAbove extends ViewGroup {
	...
	private void determineDrag(MotionEvent ev, boolean dragEnable) {
		dragEnable = false;
		...
		if (dragEnable || (xDiff > (isMenuOpen()?mTouchSlop/2:mTouchSlop) && xDiff > yDiff && thisSlideAllowed(dx))) {		
			startDrag();
			mLastMotionX = x;
			mLastMotionY = y;
			setScrollingCacheEnabled(true);
